    ...
    <section className="bg-white py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-center text-black">Conseils pour votre réservation</h2>
          
          <Collapsible className="mb-4">
            <CollapsibleTrigger className="flex items-center justify-between w-full rounded-lg border bg-card p-4 text-left font-medium text-black">
          ...
          <Collapsible className="mb-4">
            ...
            <CollapsibleContent className="bg-card px-4 pb-4 pt-2 rounded-b-lg border border-t-0">
              <p className="text-black">Pour un voyage à moto, privilégiez les hébergements offrant :<br />
          ...
          <Collapsible>
            ...
            <CollapsibleContent className="bg-card px-4 pb-4 pt-2 rounded-b-lg border border-t-0">
              <p className="text-black">Les meilleures périodes pour un voyage à moto en Corse sont :<br />
