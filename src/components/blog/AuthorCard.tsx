  ...
  return (
    ...
    >
      ...
      <div className="flex items-start space-x-5">
        ...
        <div>
          <h3 className="font-bold text-lg mb-2 text-corsica-dark font-heading">{author.name}</h3>
          <p className="text-gray-600 leading-relaxed">
            {author.bio || `Passionné de moto et de la Corse, ${author.name} partage son expertise et ses expériences 
