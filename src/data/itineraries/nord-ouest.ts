...
Surnommée "la Sublime" ou "la Route du Paradis", la Route des Crêtes (D81) est considérée comme l'un des itinéraires motards les plus spectaculaires d'Europe. Cette route de corniche exceptionnelle de 70 km relie Calvi à Porto en épousant les contours accidentés de la côte nord-ouest de la Corse. Taillée à flanc de falaise entre ciel et mer, elle offre un festival de virages techniques et de panoramas à couper le souffle sur la Méditerranée. L'itinéraire alterne entre passages montagneux culminant à plus de 400 mètres d'altitude et descentes vertigineuses vers des criques sauvages. Avec ses paysages grandioses sur les golfes de Girolata et de Porto, ses villages perchés et ses formations rocheuses rougeoyantes, la Route des Crêtes constitue une expérience de pilotage inoubliable qui sollicitera autant vos compétences techniques que votre appareil photo.

## L'itinéraire en détail

### Départ de Calvi
Le circuit débute traditionnellement à Calvi, ville fortifiée emblématique de la Balagne avec sa citadelle génoise dominant la baie. Prenez le temps de faire le plein d'essence et de vérifier votre moto avant de vous engager sur cet itinéraire exigeant.

### La section initiale (Calvi → Galeria)
Caractéristiques : Route sinueuse de largeur moyenne, montée progressive, premiers panoramas impressionnants.

Cette première section vous fait quitter progressivement la zone urbaine pour entrer dans le vif du sujet :

* Sortie de Calvi (km 0-5) : La route s'élève rapidement au-dessus de la baie, offrant de superbes vues sur la citadelle et les plages.
* Capo di a Mursetta (km 15) : Premier point de vue majeur avec un panorama à 180° sur la Balagne et le golfe de Calvi.
* Col de Palmarella (km 25, 408m d'altitude) : L'un des points culminants de l'itinéraire avec une vue imprenable sur la mer et les montagnes environnantes. Un arrêt s'impose pour immortaliser le moment.
* Descente vers Galeria (km 25-35) : Succession de virages en épingle avec une vue plongeante sur la mer. La route se resserre et exige une concentration totale.

### Le cœur de l'itinéraire (Galeria → Osani)
Caractéristiques : Tronçon le plus technique et spectaculaire, route étroite, corniche vertigineuse, virages en épingle serrés.

C'est ici que l'itinéraire prend toute sa dimension mythique :

* Galeria (km 35) : Petit port de pêche authentique, idéal pour une pause café avant d'attaquer la section la plus exigeante. Dernière station-service avant Porto.
* Réserve naturelle de Scandola (km 40-45) : La route surplombe cette réserve classée au patrimoine mondial de l'UNESCO. Plusieurs belvédères aménagés permettent d'admirer les formations rocheuses volcaniques qui plongent dans une mer turquoise.
* Girolata (visible mais inaccessible en moto) : Ce village isolé, uniquement accessible par bateau ou sentier pédestre, apparaît en contrebas comme une carte postale.
* Falaises de Piana (aperçu à distance, km 50) : Premier aperçu des célèbres falaises rougeoyantes qui seront pleinement visibles à l'approche de Porto.

### La section finale (Osani → Porto)
Caractéristiques : Route plus large mais toujours technique, descente progressive, vues panoramiques sur le golfe de Porto.

Cette dernière portion vous conduit vers la conclusion spectaculaire de l'itinéraire :

* Osani (km 55) : Village perché offrant une vue spectaculaire sur le golfe de Porto et les calanques de Piana.
* Descente vers Porto (km 55-65) : Succession de virages en lacets avec une vue de plus en plus saisissante sur le golfe et la tour génoise de Porto.
* Les Calanches de Piana (km 65-70) : Section finale traversant les célèbres formations rocheuses rouges, un paysage lunaire sculpté par l'érosion. Cette portion est particulièrement prisée des photographes en fin de journée lorsque le soleil couchant enflamme les roches.
* Arrivée à Porto (km 70) : Petite marine pittoresque dominée par sa tour génoise, point final de cet itinéraire d'exception.

## Conseils spécifiques pour les motards

### Défis techniques
* Virages : Plus de 300 virages sur l'ensemble du parcours, dont de nombreuses épingles sans visibilité et à fort dévers, particulièrement entre Galeria et Osani.
* Largeur de route : Par endroits, la chaussée ne dépasse pas 3m de large, rendant les croisements délicats, notamment avec les camping-cars et autobus touristiques fréquents en haute saison.
* Revêtement : Généralement bon mais avec des portions irrégulières, présence possible de gravillons en sorties de virage et de chutes de pierres après les épisodes pluvieux.
* Exposition : Certaines sections n'ont pas de glissière de sécurité, avec un vide impressionnant côté mer. La concentration doit être maximale.
* Tunnels : Quelques tunnels courts et non éclairés entre Galeria et Porto. Attention au changement brutal de luminosité, particulièrement dangereux avec des lunettes teintées.

### Timing et saisons
* Durée recommandée : Si le trajet pur est réalisable en 2h30, prévoyez au minimum 4-5h avec les arrêts photos, et idéalement une journée entière pour profiter pleinement des panoramas et des villages.
* Meilleure période : Mai, juin et septembre offrent le meilleur compromis entre météo favorable, luminosité idéale et trafic modéré.
* À éviter absolument : Juillet-août entre 10h et 16h (embouteillages, bus touristiques nombreux), jours de mistral fort (rafales dangereuses sur les portions exposées), crépuscule et nuit (absence d'éclairage, risque animalier accru).
* Moment idéal : Tôt le matin (7h-9h) pour la lumière et le trafic minimal, ou en fin d'après-midi (après 17h en été) pour capturer la lumière dorée sur les Calanches de Piana.
